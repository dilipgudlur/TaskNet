...
public class Preferences {
    ...
    public static final int TOTAL_BATTERY_AT_NODE = 10000;
    public static final int RESERVED_BATTERY_AT_NODE = 100;
    public static final int BATTERY_SPENT_IN_COMMUNICATION_SEND = 2;
